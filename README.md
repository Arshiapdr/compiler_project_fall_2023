...
- $${\color{red}Red}$$ __Dead Variable:__ A variable that is not related to the __result__ and the value of the __result__ is not dependent on it, is a dead variable.
